...
export class UsersComponent implements OnInit {
   ...
   Update(){
    this.updateUser(this.objUser.idUser,this.objUser.login,this.objUser.password,this.objUser.nameUser,
                    ...
                    this.objUser.mfUser, this.objUser.steUser,this.objUser.cout,this.objUser.codeParenage )
                    window.location.reload();

   }
   updateUser(idUser,login,password,nameUser,surnameUser,emailUser,mobileUser,adress,mfUser,steUser,cout,codeParenage){
    let Userdata = {
        login:login,
        password:password,
        nameUser: nameUser,
 ...
 changeDateFormatMDY(dd){
    ...
    generateExcel() {
        ...
        () => {
            if (this.markedCheckbox === true) {
                this.inPayementTrip(this.listTripTopayed)
            }
    ...
    inPayementTrip(listTripTopayed) {
