...
/* export function autocompleteAdr(delegInput, tunisiaData, awesomplete) {
  var awesomplete = new Awesomplete(delegInput, {
    minChars: 1,
    autoFirst: true
  });
  delegInput.on("keyup", function(){
    awesomplete.list = tunisiaData;
  });
